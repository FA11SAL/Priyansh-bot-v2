...
const dataPath = __dirname + "/Sameer/approvedThreads.json";
const dataPending = __dirname + "/Sameer/pendingdThreads.json";
const fs = require("fs");
...
module.exports.run = async ({ event, api, args, Threads, handleReply, Users }) => {
  ...
  const cre = this.config.credits
      ...
      api.sendMessage(`[ OK ] Your group has been removed from the browsing list by the admin for the reason: ${lydo}`, idBox);
   	...
   	else api.sendMessage("[ OK ] ✨ApKa Group Approved Kar Diya Hai🙌.\n 🖤So Enjoy\n\n 💝🥀𝐎𝐖𝐍𝐄𝐑:- 🧡↻ 𝐒𝐚𝐦𝐞𝐞𝐑 𝐊𝐇𝐚𝐧 ↻🧡\n 🧡𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 〠𝕊𝕒𝕞𝕖𝕖ℝ🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞ https://www.facebook.com/share/1A8uLy1Dmw/\n👋For Any Kind Of Help Contact On Telegram  Username 👉 @SameerKHan😇", idBox, (error, info) => {
